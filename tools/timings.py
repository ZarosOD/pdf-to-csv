...
catalog-watch, feed-clean, inbox-filer), and the maintainers' drift checker is
what holds it that way, from its SHARED_ROOT list (THE-274). That checker is a
rookery tool and is not in this repo. It is stdlib only and needs no venv,
